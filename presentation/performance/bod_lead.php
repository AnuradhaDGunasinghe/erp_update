...
$timestamp2 = strtotime(date('Y-m-d 14:30:00'));
...
<div class="col col-sm-6 col-md-3">
    ...
    $start_time = $date;
    $end_time = $date2; ?>
    <a href="bodywork_team_performance.php">
        <div class="info-box">
            <span class="info-box-icon bg-info elevation-1"><i class="fa-solid fa-warehouse"></i></span>

            <div class="info-box-content">
                <span class="info-box-text">Team Performance
                </span>
            </div>
            <!-- /.info-box-content -->
        </div>
                    ...
                    <div class="d-flex">
                        <div class="col-lg-6 grid-margin stretch-card justify-content-center mx-auto mt-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 mt-2" style="font-size:16px">
                                    <?php
                                    $query = "SELECT COUNT(qr_number) as count FROM performance_record_table WHERE (job_description='Bodywork' OR job_description='Sanding' OR job_description='Taping' OR job_description='bodywork+sanding'OR job_description='bodywork+sanding+taping' OR job_description='High Gen bodywork+sanding+taping' OR job_description='Low Gen bodywork+sanding+taping') AND status='1' AND end_time between '$date'AND '$date2' ";
                                    $query_run = mysqli_query($connection, $query);
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 mt-2" style="font-size:16px">
                                    <?php
                                    $query = "SELECT COUNT(qr_number) as count FROM performance_record_table WHERE (job_description='Bodywork' OR job_description='Sanding' OR job_description='Taping' OR job_description='bodywork+sanding' OR job_description='High Gen bodywork+sanding+taping' OR job_description='Low Gen bodywork+sanding+taping') AND status='0' AND start_time between '$date'AND '$date2' ";
                                    $query_run = mysqli_query($connection, $query);
                                    $r_count = 0;
                                    foreach ($query_run as $data) {
                                        $r_count = $data['count'];
