                        ...
                        <div class="col-lg-6 grid-margin stretch-card justify-content-center mx-auto mt-2">
                            <form method="POST" action="performance_record_save.php">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 mt-2" style="font-size:16px">
                                        <label class="col-sm-6 col-form-label">sticker printing 300/ sorting
                                            700</label>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <label class="col-sm-6 col-form-label">point view for testing</label>
                                    <div class="col-sm-4 mt-2" style="font-size:16px">
                                        <?php
                                    echo "1.24 point for Inventory Testing HP , ";
                                                        echo "1.00 point for Inventory Testing Dell , ";
                                                        echo "1.24 point for Inventory Testing Lenovo ";
                                                        ?>
                                    </div>
                                </div>
                                <div class="row">
