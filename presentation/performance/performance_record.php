                            ...
                            <div class="col-lg-6 grid-margin stretch-card justify-content-center mx-auto mt-2">
                                <form method="POST" action="performance_record_save.php">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8 mt-2">
                                            <select name="job_description" onchange="checkOptions(this)"
                                                ...
                                                <option value="Combine+ Test">Combine + Test </option>
                                                <option value="Inventory Testing Lenovo">Inventory Testing Lenovo
                                                </option>
                                                <option value="Inventory Testing Dell">Inventory Testing Dell
                                                </option>
                                                <option value="Inventory Testing HP">Inventory Testing HP
                                                </option>
                                                <?php }
                                                ...
                                                <option value="High Gen bodywork+sanding+taping">High Gen
                                                    Bodywork+Sanding+Taping
                                                </option>
                                                <option value="Low Gen bodywork+sanding+taping">Low Gen
                                                    bodywork+sanding+taping
                                                </option>
                                                <option value="bodywork+sanding">Bodywork+Sanding
                                                </option>
                                    ...
                                    <div class=" row">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="w-75" style="color:black !important" type="text" id="qr"
                                                name="qr" placeholder=" scan qr code here">
                                        </div>
                                    </div>
                                            ...
                                            <?php $query = "SELECT SUM(target) as target_sum FROM performance_record_table WHERE user_id = $user_id AND end_time between '$date'AND '$date2' ";
                                                ...
                                                if ($department_id == 1) {
                                                    if ($user_role == 33) {
                                                        ...
                                                        echo "1 point for combine / testing ,";
                                                        echo "0.6 point for Inventory Testing HP , ";
                                                        echo "0.5 point for Inventory Testing Dell , ";
                                                        echo "0.6 point for Inventory Testing Lenovo ";
                                                    }
                                                } elseif ($department_id == 10) {
                                                    if ($user_role == 9) {
