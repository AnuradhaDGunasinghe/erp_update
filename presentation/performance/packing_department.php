                ...
                <div class="card-body">
                    ...
                    <table id="tblexportData" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            $j = 1;
                            $spend_time = 0;
                            $query = "SELECT * FROM performance_record_table WHERE user_id=$user_id AND start_time between '$date'AND '$date2' ORDER BY performance_id DESC LIMIT 5";
                            $query_run = mysqli_query($connection, $query);
...
if (isset($_POST['submit'])) {
    ...
    echo $dispatch;
        ...
        echo 'window.location.href = "packing_department.php";';
        echo '</script>';
        }elseif($dispatch==0){
            echo "<script>
