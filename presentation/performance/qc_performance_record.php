...
$timestamp2 = strtotime(date('Y-m-d 14:30:50'));
$timestamp3 = strtotime(date('Y-m-d 18:45:00'));
...
if (strtotime(date('Y-m-d 09:00:00')) < $now && $now > $_SESSION['expire1'] && $now < strtotime(date('Y-m-d 15:00:00'))) {
    ...
    header("Location: ../../index.php");
} elseif (strtotime(date('Y-m-d 15:00:00')) < $now && $now > $_SESSION['expire2'] && $now < strtotime(date('Y-m-d 18:40:00'))) {
    session_destroy();
    echo "<p align='center'>Session has been destroyed!!";
    header("Location: ../../index.php");
...
<div class="row m-2">
    <div class="col-12 col-sm-6 col-md-3 mt-3">
        ...
        $start_time = $date;
        $end_time = $date2; ?>
        <a href="reject_record.php">
            <div class="info-box">
                <span class="info-box-icon bg-info elevation-1"><i class="fa-solid fa-warehouse"></i></span>

                <div class="info-box-content">
                    <span class="info-box-text">Reject Report
                    </span>
                </div>
                <!-- /.info-box-content -->
            </div>
                    ...
                    <table id="tblexportData" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $technician. "    ".$uname ?></td>
        ...
        <div class="modal-content ">
            ...
            <?php if (isset($_POST['submit'])) {
             ...
             WHERE performance_id = $performance_id";
                ...
                if ($lcd == 'reject') {
                    $query = "SELECT user_id FROM performance_record_table WHERE qr_number='$search_value' AND department_id='10' AND job_description='Install LCD'";
                    $query_run = mysqli_query($connection, $query);
                    ...
                    if ($reject_person == 'null') {
                        $query = "SELECT user_id FROM performance_record_table WHERE qr_number='$search_value' AND department_id='1' AND (job_description='Put RAM + Hard Disk + Test')";
                        $query_run = mysqli_query($connection, $query);
