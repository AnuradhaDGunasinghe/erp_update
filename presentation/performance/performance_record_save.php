...
if ($end_time == "0000-00-00 00:00:00" && $same_jd_count == 1 && $status == 0) {
    ...
    if ($department_id == 1) {
        if ($_SESSION['role_id'] == 33) {
            $target = 1;
        } elseif($job_description =="Inventory Testing Lenovo"){ $target = 0.62;}
        elseif($job_description =="Inventory Testing Dell"){ $target = 0.50;}
        elseif($job_description =="Inventory Testing HP"){ $target = 0.62;}
        else {
            $target = 1;
        }
    ...
    } elseif ($department_id == 7 || $department_id == 22) {
        ...
        if($job_description =="Inventory Testing Lenovo"){ $target = 1.24;}
        elseif($job_description =="Inventory Testing Dell"){ $target =1.0;}
        elseif($job_description =="Inventory Testing HP"){ $target = 1.24;}
        else {
            $target = 1;
        }
