    ...
    <div class="row ">
        <div class="col-lg-11 grid-margin stretch-card justify-content-center mx-auto ">
            <div class="card mt-3">
                <div class="card-body">
                    <?php
                    $query = "SELECT technician_id FROM performance_record_table WHERE user_id ='$user_id' ORDER BY performance_id DESC LIMIT 1";
                        ...
                        <div class="col-lg-6 grid-margin stretch-card justify-content-center mx-auto mt-2">
                            <form method="POST" action="pro_teamlead_save.php">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 mt-2">
                                        <select name="job_description" class="info_select w-75"
                                            ...
                                            <option selected value="send to production technician">Send to Production
                                                Technician</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 mt-2">
                                        <select name="technician_id" class="info_select w-75"
                                            style="border-radius: 5px;">

                                            <option selected value="<?php echo $last_technician ?>">
                                                <?php echo $last_technician ?>
                                            </option>
                                            <?php $query = "SELECT username FROM users WHERE department='1' AND (role='4' || role='33'||role='11')";
    ...
    <div class='row'>
        <div class="col col-lg-4 justify-content-center  text-uppercase">
            <table id="tblexportData" class="table table-striped">
                ...
                <tbody>
                    <?php
                    $query = "SELECT username,user_id FROM users WHERE department='1' AND (role='4' || role='33'||role='11') ";
                    $query_run = mysqli_query($connection, $query);
                    ...
                    <tr>
                        <td>
                            <a
                                href="prod_team_lead.php?id=<?php echo $user_id ?>&name=<?php echo $username ?>"><?php echo $username; ?></a>
                        </td>
                        <td><?php
                                $date1 = new DateTime('now', new DateTimeZone('Asia/Dubai'));
                                $date = $date1->format('Y-m-d 00:00:00');
                        ...
                        <!-- <td><?php $ithuru = $total_count - $iwara;
                                echo $ithuru; ?></td> -->
                    </tr>
                    <?php }
                    ?>
