...
<div class="row page-titles">
    <div class="col-md-5 align-self-center"><a
            href="./model_view2.php?brand=<?php echo $brand ?>&model=<?php echo $model ?>">
...
$query = "SELECT * FROM `warehouse_information_sheet` WHERE brand = '$brand' AND model='$model'AND core='$core' AND send_to_production= '0'  AND location = 'WH2'  AND reprint= '1' ";
