...
<div class="row m-2">
    <div class="col-12 mt-3">
        ...
        <a class="btn bg-gradient-warning mx-2 text-white" type="button" href="./js_check.php"><i
...
<div class="row m-2">
    <div class="col-12 mt-3">
        ...
        <a class="btn bg-gradient-info mx-2 text-white" type="button" href="sorting_temp.php"><i
                class="fa-solid fa-layer-plus"></i><span class="mx-1">Sorting</span></a>
        <a class="btn bg-gradient-info mx-2 text-white" type="button" href="add_asin.php"><i
                class="fa-solid fa-layer-plus"></i><span class="mx-1">Upload ASIN</span></a>
        <a class="btn bg-gradient-primary mx-2 text-white" type="button" href="warehouse_stock_report2.php"><i
                class="fa-solid fa-book"></i><span class="mx-1">WH2 Stock Report</span></a>
    </div>
</div>
