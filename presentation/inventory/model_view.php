...
foreach ($result as $data) {
    ...
    echo "
                                    ...
                                    <td>$brand</td>
                                    <td>$model</td>
                                    <td><a  href='spec_view.php?model=$model&brand=$brand&core=$core'>$core</a></td>
                                    <td>$generation</td>
                                    <td><a  href='asin_view.php?model=$model&brand=$brand&core=$core&gen=$generation'>Asin</a></td>
                                    <td>$in_total</td>
                                    ";
    echo "<td>";
    ...
    $query = "SELECT COUNT(inventory_id)as dispatch FROM `warehouse_information_sheet` WHERE brand = '$brand' AND model='$model'AND core='$core' AND send_to_production='1' AND dispatch='1'";
    $result = mysqli_query($connection, $query);
    foreach ($result as $data) {
    ...
    echo $in_stock;
    echo "</td><td>";
     $query = "SELECT COUNT(inventory_id)as processing FROM `warehouse_information_sheet` WHERE brand = '$brand' AND model='$model'AND core='$core' AND send_to_production='1' AND dispatch='0'";
    $result = mysqli_query($connection, $query);
    foreach ($result as $data) {
    ...
    $query = "SELECT non_touch_wholesale_price, COUNT(touch_or_non_touch)as touch_or_non_touch
                                            FROM `warehouse_information_sheet` WHERE brand = '$brand' AND model='$model'AND core='$core' AND send_to_production='0' AND touch_or_non_touch='yes'";
    ...
    $query = "SELECT touch_wholesale_price, COUNT(battery)as battery FROM `warehouse_information_sheet` WHERE brand = '$brand' AND model='$model'AND core='$core' AND send_to_production='0' AND battery='no'";
    $result = mysqli_query($connection, $query);
    foreach ($result as $data) {
