    ...
    // $start_print = 1;
     ...
     if($kb==0){
                ...
                ///////////////////////////////////////////
                    ...
                    imagepng($im, "files2/$username test1.png");
                    imagedestroy($im);
                //////////////////////////////////////////////////////////////////////////
...
// foreach($query_run as $data){
    ...
    ?>
                            ...
                            <div class="row">
                                <label class="col-sm-3 col-form-label">Resolution Type</label>
                                <div class="col-sm-8 w-100">
                                    <select name="screen_resolution_type" id="screen_resolution_type"
...
if ($exist == 'yes') {
    ?>
        ...
        if ($generation > 5) {?>
                            ...
                            <!-- /////////////////////////////////////////////////////////////////////////////// -->
                            <div class="row">
                                <label class="col-sm-3 col-form-label">Backlit</label>
                                <div class="col-sm-8 w-100">
                                    <select class="w-100" name="kb" id="kb" style="border-radius: 5px;" required>
                                        <option></option>
                                        <option value='yes'>Yes</option>
                                        <option value='no'>No</option>
                                    </select>
