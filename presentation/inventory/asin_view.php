                        ...
                        <table class="table">
                            ...
                            <tbody class="table-body">
                                ...
                                <?php
                                    ...
                                    $query = "SELECT asin,model,generation,core, COUNT(inventory_id) as in_total FROM `warehouse_information_sheet` WHERE brand = '$brand' AND model = '$model' AND core='$core'  GROUP BY asin";
